...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Att: ? ";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo conociendote: <b>${days}</b> días<br>` +
      `Dias para seguir conociendote: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
